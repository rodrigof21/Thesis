...
- Organized Github project and notes
- automated internal documentation
- Plotted Bode diagrams for various nu, zeta and wn ([[bode.m]])


### 07-02
---
- Trying to find the unit step response from the frequency response. 
- Gemini gave me a how-to ([[Unit step response - inverse Fourier]]) but i can't find where those formulas came from. 
