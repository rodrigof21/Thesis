...
% Filter Data
y_filtered = movmean(y_noise, 30);
% y_filtered = lowpass(y_noise, 0.0001);
% y_filtered = sgolayfilt(y_noise, 2, 15);
% y_filtered = y_noise;
...
function [tau1, tau2, tau3, tau4, tau5, tp, Mp, t05] = extractPoints_noise(t, noise_y)
    ...
    % % Mp tp Overshoot
    % [pks, locs] = findpeaks(noise_y(1:600), t(1:600), 'MinPeakHeight', 1.05);
